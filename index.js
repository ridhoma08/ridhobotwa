...
/////////////////
const BotName = 'DOTIT BOTʕ•ﻌ•ʔ'; 
const instagram = 'https://instagram.com/ridhoma_08?igshid=o9ozmocdtzek'; 
const telegram = 'LINK TELEMU'; 
const kapanbotaktif = 'KETIKA KAMU CHAT BOT AKTIF'; 
const youtube = 'https://www.youtube.com/channel/UCX2dN7mSlEMaRxwmJJb3IXg';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@ridhoma_08')
